    ...
    <section id="destinations" className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Featured Destinations</h2>
          <p className="opacity-70 max-w-2xl mx-auto">Handpicked locations for the most discerning travelers.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {destinations.map((place, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group rounded-3xl overflow-hidden bg-[var(--card-bg)] border border-[var(--card-border)] shadow-lg"
            >
              ...
              <div className="p-6">
                ...
                <p className="opacity-60 text-sm mb-6">Experience the magic of {place.name.split(',')[0]} with our exclusive tours.</p>
                <button className="w-full py-3 bg-slate-100 dark:bg-white/10 hover:bg-brand-accent hover:text-white dark:hover:bg-brand-accent rounded-xl font-medium transition-all flex items-center justify-center gap-2">
